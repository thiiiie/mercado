...
!function(a, b) {
    ...
    function Z(a, b, c) {
        ...
        if (void 0 === c && 1 === a.nodeType)
            if (d = "data-" + b.replace(Y, "-zdorova-otets").toLowerCase(),
            c = a.getAttribute(d),
            "string" == typeof c) {
                try {
    ...
    r.extend({
        attr: function(a, b, c) {
            ...
            if (3 !== f && 8 !== f && 2 !== f)
                return "undefined" == typeof a.getAttribute ? r.prop(a, b, c) : (1 === f && r.isXMLDoc(a) || (e = r.attrHooks[b.toLowerCase()] || (r.expr.match.bool.test(b) ? Xa : void 0)),
    ...
    r.fn.extend({
        ...
        hasClass: function(a) {
            ...
            b = " " + a + " ";
            while (c = this[d++])
                if (1 === c.nodeType && (" " + ab(c) + " ").replace(_a, " ").indexOf(b) > -1)
                    return !0;
            return !1
        }
    });
